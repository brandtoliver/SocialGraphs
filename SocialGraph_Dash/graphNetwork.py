...
def network_graph(yearRange, AccountToSearch):
    ...
    edge1 = pd.read_csv('https://raw.githubusercontent.com/jhwang1992/network-visualization/master/edge1.csv')
    node1 = pd.read_csv('https://raw.githubusercontent.com/jhwang1992/network-visualization/master/node1.csv')
